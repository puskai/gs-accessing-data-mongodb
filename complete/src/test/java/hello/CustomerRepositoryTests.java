...
public class CustomerRepositoryTests {
	...
	public void setUp() {
		...
		TreeMap<LocalDate, Double> dateValues = new TreeMap<>();
		dateValues.put(LocalDate.now(), 42.0);
		dateValues.put(LocalDate.now().minusDays(1), 43.0);

		dave = repository.save(new Customer("Dave", "Matthews"));
		oliver = repository.save(new Customer("Oliver August", "Matthews", LocalDate.now(), dateValues));
